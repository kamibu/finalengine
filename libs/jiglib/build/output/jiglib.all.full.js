...
(function(jigLib){
	...
	var JBox=function(skin, width, depth, height){
		...
		//this.Super(skin);
		jigLib.RigidBody.call(this, skin );
...
(function(jigLib){
	...
	*/
	...
	JOctree.prototype.doesTriangleIntersectCell=function(triangle, cell){
		...
		for (var i = 0; i < 12; i++ ) {
			edge = edges[i];
			seg = new jigLib.JSegment(pts[edge.ind0], Vector3DUtil.subtract(pts[edge.ind1],pts[edge.ind0]));
		...
		for (i = 0; i < 3; i++ ) {
			...
			if (cell.AABox.segmentAABoxOverlap(new jigLib.JSegment(pt0, Vector3DUtil.subtract(pt1,pt0)))) {
				return true;
			}
		}
		return false;
